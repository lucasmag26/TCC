            ...
            <!-- #################################################################### -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" action="PHP/cadastro_compra.php" method="post">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2" for="hora">Hora:</label>
                                <div class="input-group col-md-2">
                                    <span class="input-group-addon">&#128338;</span>
                                    <input type="time" name="hora" id="hora" OnKeyPress="formatar('##:##', this)" placeholder="00:00" maxlength="5" class="form-control" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
