            ...
            <!-- #################################################################### -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" action="PHP/cadastro_venda.php" method="post">
                            <div class="form-group">
                                <label class="control-label col-md-2" for="cliente">Cliente:</label>
                                <div class="input-group col-md-4">
                                    <span class="input-group-addon">&#128100;</span>
                                    <input type="text" name="cliente" id="cliente" class="form-control" placeholder="Cliente" required="required" />
                                </div>
                            </div>
                            <div class="form-group">
