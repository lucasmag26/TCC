                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Estoque <i class="fa fa-cubes"></i>
                        </h1>
                        <form class="form-horizontal" action="PHP/cadastro_estoque.php" method="post">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2" for="fornecedor">Fornecedor:</label>
                                <div class="input-group col-md-4">
                                    <span class="input-group-addon">&#128230;</span>
                                    <input type="text" name="fornecedor" id="fornecedor" class="form-control" placeholder="Fornecedor" required="required" />
                                </div>
                            </div>
                            <div>
