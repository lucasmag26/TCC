...
<head>
    ...
    <title>Cadastro-Produto-da-venda</title>
            ...
            <!-- #################################################################### -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" action="PHP/cadastro_produtodavenda.php" method="post">
                            <div class="form-group">
                                <label class="control-label col-md-2" for="produtofinal">Produto Final:</label>
                                <div class="input-group col-md-4">
                                    <span class="input-group-addon">&#128142;</span>
                                    <input type="text" name="produtofinal" id="produtofinal" class="form-control" placeholder="Produto Final" required="required" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group col-md-2">
                                    ...
                                    <input type="number" min="0" name="quantidade" id="quantidade" class="form-control" placeholder="Quantidade" required="required" min="0" />
                                </div>
                            </div>
                            <div>
