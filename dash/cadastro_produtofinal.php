...
<head>
    ...
    <title>Cadastro-Produto-final</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Produto Final <i class="fa fa-cube"></i>
                        </h1>
                        <form class="form-horizontal" action="PHP/cadastro_produtofinal.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-md-2">
                                    <span class="input-group-addon">&#128178;</span>
                                    <input type="text" name="preco" id="preco" class="form-control" placeholder="R$" required="required" />
                                </div>
                            </div>
                            <div class="form-group">
