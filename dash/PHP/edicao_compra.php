...
<head>
    ...
    <title>Dashboard/Edição/Compra</title>
...
<body>
    ...
    <div id="wrapper" class="fullheight">
        ...
        <div id="page-wrapper" class="fullheight">
            ...
            <!-- #################################################################### -->
                <!-- Page Heading --><!--id_fornecedor`, `nome_fantasia`, `razao_social`, `email`, `cnpj`, `telefone`, `cep`, `estado`, `cidade`, `bairro`, `rua`, `complemento`, `numero` -->
                <div class="row">
                    <div class="col-lg-12" style="overflow-x:auto">
                        <table id="datat" class="table table-hover table-bordered"><!--17-->
                            ...
                            $sql = 'SELECT * FROM `cadastro_compra`';
